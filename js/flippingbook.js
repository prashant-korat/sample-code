...
FlippingBook.prototype.create = function(){
	...
	swfobject.embedSWF(base_url+"js/FlippingBook.swf", this.containerId, this.stageWidth, this.stageHeight, "8.0.0", "js/expressInstall.swf", this.settings, {allowScriptAccess: "always", bgcolor:  "#111111" + this.settings.backgroundColor.toString( 16 ) });
}
